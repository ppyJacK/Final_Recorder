...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static DatabaseChangedListener mDatabaseChangedListener;
    ...
    public static void setOnDatabaseChangedListener(DatabaseChangedListener listener) {
        mDatabaseChangedListener = listener;
    }
    ...
    public long addRecording(String recordingName, String filePath, long length) {
        ...
        if (mDatabaseChangedListener != null) {
            mDatabaseChangedListener.onNewDatabaseEntryAdded();
        }
    ...
    public void renameItem(RecordingItem item, String recordingName, String filePath) {
        ...
        if (mDatabaseChangedListener != null) {
            mDatabaseChangedListener.onDatabaseEntryRenamed();
        }
    }
